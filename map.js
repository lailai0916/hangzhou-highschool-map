...
const schools = [
  ...
  { name: "杭高钱塘", coord: [-1, -1], type: 2 },
  { name: "杭高临平", coord: [-1, -1], type: 2 },
  { name: "杭二东河", coord: [-1, -1], type: 2 },
  { name: "临安中学", coord: [-1, -1], type: 2 },
  { name: "余杭一中", coord: [-1, -1], type: 2 },
  { name: "杭四江东", coord: [-1, -1], type: 2 },
  { name: "杭二富春", coord: [-1, -1], type: 2 },
  { name: "杭七转塘", coord: [-1, -1], type: 2 },
  { name: "杭师大二附", coord: [-1, -1], type: 2 },
  { name: "学军桐庐", coord: [-1, -1], type: 2 },
